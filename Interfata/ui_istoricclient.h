/********************************************************************************
** Form generated from reading UI file 'istoricclient.ui'
**
...
#ifndef UI_ISTORICCLIENT_H
#define UI_ISTORICCLIENT_H
...
class Ui_istoricClient
{
public:
    QPushButton *pushButton;
    QTextBrowser *textBrowser;

    void setupUi(QWidget *istoricClient)
    {
        if (istoricClient->objectName().isEmpty())
            istoricClient->setObjectName(QString::fromUtf8("istoricClient"));
        istoricClient->resize(678, 429);
        pushButton = new QPushButton(istoricClient);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(532, 378, 111, 41));
        textBrowser = new QTextBrowser(istoricClient);
        textBrowser->setObjectName(QString::fromUtf8("textBrowser"));
        textBrowser->setGeometry(QRect(50, 30, 581, 341));
        QPalette palette;
        ...
        retranslateUi(istoricClient);

        QMetaObject::connectSlotsByName(istoricClient);
    } // setupUi

    void retranslateUi(QWidget *istoricClient)
    {
        istoricClient->setWindowTitle(QCoreApplication::translate("istoricClient", "Form", nullptr));
        pushButton->setText(QCoreApplication::translate("istoricClient", "Back", nullptr));
    } // retranslateUi

};

namespace Ui {
    class istoricClient: public Ui_istoricClient {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ISTORICCLIENT_H
